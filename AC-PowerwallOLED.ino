...
unsigned long sendinterval=7000;         // interval of sending Blynk data
byte sendpart=0;
...
if (modecounter==2) {  //mode readout 1 time a second
 mode=13;
...
if (currentcounter==2 and aquisitioncounter<=81){
  Currentaquisition();
  aquisitioncounter++;
}
...
void getVoltage(){
 ...
 diffbattvoltage=battvoltage-oldbattvoltage;
  ...
  if (diffbattvoltage>0.03 and battvoltage<54.9){
