...
byte typeofmeter=0;            //0=SDM120, 1=SDM630, 2=X835
byte settypeofmeter;
float measuredpower;
...
if (millis()>=(ledstartmillis+ledinterval)) {
 ...
 if (mode<9){
  ...
  if (currentcounter>=20){
   ...
   if (currentcounter==3 or currentcounter==10 or currentcounter==17) {
 ...
 if (currentcounter==1 and aquisitioncounter<=80){
  Currentaquisition();
  aquisitioncounter++;
 }
...
if (typeofbatt==1){
 ...
 if (battvoltage>=54.60 and battvoltage<54.74){
  ...
  if (chargerone==1) {        
  SOCvoltage=SOCvoltage-(ConeAmps*0.031);
  corrindchg=6;
  }
  if (chargertwo==1) {       
  ...
  if (chargerone==1) {       
  SOCvoltage=SOCvoltage-(ConeAmps*0.028);
  corrindchg=5;
  }
  if (chargertwo==1) {      
